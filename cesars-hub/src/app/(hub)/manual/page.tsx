        ...
        <article className="mt-10 space-y-8 text-charcoal/80">
          <section className="rounded-2xl border border-charcoal/10 bg-white p-5 sm:p-6">
            ...
            <ol className="mt-4 list-decimal space-y-2 pl-5">
              ...
              <li>Unlock with the hub key (HUB_KEY or ADMIN_UPLOAD_KEY).</li>
          ...
          <section className="rounded-2xl border border-charcoal/10 bg-white p-5 sm:p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li>
                <span className="font-semibold text-charcoal">This app — </span>
                localhost:8743 (Cesar’s Hub). Deploy as its own Vercel project with Root Directory{" "}
                <code className="text-charcoal">cesars-hub</code>. Do not attach the barber domain.
              </li>
              <li>
                <span className="font-semibold text-charcoal">Public site — </span>
                Vercel project{" "}
              ...
              <li>
                ...
                GitHub THE-BARBER-LOUNGE. Folder <code className="text-charcoal">cesars-hub/</code>{" "}
                is the hub.
              </li>
              <li>
                <span className="font-semibold text-charcoal">Shop data — </span>
                Postgres when DATABASE_URL / TBLDB_* is set. Otherwise JSON under data/.
              </li>
              <li>
