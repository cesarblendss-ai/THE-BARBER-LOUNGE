...
| 2 | `blog_post_1.md` | Full SEO article (~1,120–1,500 words) |
...
| Run | Folder | Notes |
|-----|--------|-------|
| v1 (buggy topics) | `tools/seo-agent/output/the_barber_lounge_2026_08_08/` | Blog topics parsed from markdown table garbage — **do not use** |
...
**Domain note:** `SITE_URL` in `src/lib/constants.ts` is still `https://thebarberlounge.com` — update when custom domain goes live or canonicals will be wrong. Current deploy URLs: `docs/team-memory/deploy.md`.
...
See also: `docs/team-memory/flaky-tests.md` for SEO v1 table bug notes.
