> **Canonical copy:** [`docs/org-conventions/booking-system.md`](../org-conventions/booking-system.md) — update there, not here.
...
See `twilio-sms-status.md` for current SMS blocker.
